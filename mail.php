...
$email = 'callzentr@bk.ru, diamond.clinik@yandex.ru'; // адрес куда отправлять письмо, можно несколько через запятую
...
$from = '9101324392@srv249-h-st.jino.ru'; // имя отправителя (необязательно)
